...
var destroy = function (destroyControls=true){
...
var drawArea = function (area_drawer, area_data, datum_accessor, class_match = 'chart-area', bind_accessor, attr_accessor = function(d){return d}){
...
var makeLegend = function (scale = this.colorScale, label='', custom_data=null){
  let config = this.config;
