...
define(['d3'], function (d3$1) {
  ...
  function init(data) {
    ...
    var startup = function startup(data) {
      ...
      var visible = d3.select(_this3.div).property('offsetWidth') > 0;
      if (!visible) {
        ...
        var onVisible = setInterval(function (i) {
          var visible_now = d3.select(_this3.div).property('offsetWidth') > 0;
          if (visible_now) {
            _this3.layout();
  ...
  function checkRequired(data) {
    ...
    requiredCols.forEach(function (e, i) {
      if (colnames.indexOf(e) < 0) {
        d3.select(_this10.div).select('.loader').remove();
  ...
  function makeSubsetterControl(control, control_wrap) {
    ...
    changer.on('change', function (d) {
      ...
      if (control.multiple) {
        ...
        (function () {
          var value = d3.select(_this12).select("option:checked").property('text');
