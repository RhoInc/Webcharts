...
function setDomain(axis) {
    ...
    if (this.config[axis].type === 'ordinal') {
        ...
        } else if (this.config[otherAxis].type === 'time' && this.config[axis].sort === 'earliest') {
    ...
    if (this.config[axis].type === 'linear' && this[axis + '_dom'][0] === this[axis + '_dom'][1]) this[axis + '_dom'] = [this[axis + '_dom'][0] - this[axis + '_dom'][0] * 0.01, this[axis + '_dom'][1] + this[axis + '_dom'][1] * 0.01];
    ...
    if (this.filters.length) {
        this.filters.forEach(function (filter) {
            _this.filtered_data = _this.filtered_data.filter(function (d) {
                return filter.val === 'All' ? d : filter.val instanceof Array ? filter.val.indexOf(d[filter.col]) > -1 : d[filter.col] === filter.val;
            });
        });
    }
