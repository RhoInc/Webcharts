      ...
      if (sublevel) {
        ...
        this_nest.sortKeys(function (a, b) {
          ...
          if (_this.config.x.type === 'time') {
            ...
            sort = d3.ascending(_this.config.x.order.indexOf(a), _this.config.x.order.indexOf(b));
          } else if (sublevel === _this.config.color_by && _this.config.legend.order) {
            sort = d3.ascending(_this.config.legend.order.indexOf(a), _this.config.legend.order.indexOf(b));
