...
\------------------------------------------------------------------------------------------------*/
    ...
    function draw$1(passed_data, processed_data) {
        ...
        if (this.config.exportData)
            this.config.exportFormats.forEach(function(fmt) {
    ...
    function csv(data) {
        ...
        if (!data)
            data = this.data.filtered[0].values.map(function(d) {
                return d.raw;
            });
    ...
    function setDefaults$1() {
        ...
        this.config.exportFormats = this.config.exportFormats !== undefined
            ? this.config.exportFormats.map(function(fmt) {
